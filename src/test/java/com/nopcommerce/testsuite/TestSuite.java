...
public class TestSuite extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        checkoutPage.sendFirstName("ishita");
        checkoutPage.sendLastName("jhgujn");
        checkoutPage.sendEmail("ish@gmail.com");
        checkoutPage.selectCountryName("United Kingdom");
        checkoutPage.sendCityName("London");
        checkoutPage.sendAddressName("36 Brampton road");
        checkoutPage.sendPostCode("NW9 9BU");
        checkoutPage.sendPhoneNumber("07748406878");
        // Click on “CONTINUE”
        ...
        checkoutPage.sendCardholderName("Miss Ishita Malhotra");
